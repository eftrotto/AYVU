...
// hairStyle "afro": nos estilos "long"/"bangs"/"ponytail", o desenho tem
// frestas entre os fios que caem bem na testa — como o body/*.png não
// desenha nada ali (espera o cabelo cobrir 100%), a fresta vira um buraco
// mostrando o fundo da cena (confirmado com fundo magenta). "afro" é o
// único sem nenhuma falha nesse frame.
...
// Sem isso, as 7 camadas do avatar chegam em momentos diferentes na primeira
// vez que o Macu aparece, e dá pra ver um instante de camada errada.
