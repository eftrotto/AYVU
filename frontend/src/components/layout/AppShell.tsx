      ...
      <div className={`mx-auto ${larguraMaxima[largura]} px-5 py-7`}>
        {voltar && (
          <button
            ...
            className="mb-5 inline-flex items-center gap-1 rounded-full border border-border bg-card px-4 py-2 text-sm font-bold text-text-soft hover:border-accent hover:text-accent"
          >
            ‹ {voltar.rotulo}
          </button>
        )}
